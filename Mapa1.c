...
int main()
{
    ...
    FILE *arquivo = fopen("Mapas/Mapa1.txt", "r");
    ...
    InitWindow(960, 960, "Mapa1");

    Texture2D lad = LoadTexture("Texturas/escada.png");
    Texture2D plat = LoadTexture("Texturas/plataforma.png");
